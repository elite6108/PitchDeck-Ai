    ...
    try {
      ...
      if (aiStyledDeck.slides) {
        aiStyledDeck.slides = aiStyledDeck.slides.map(slide => {
          ...
          styledSlide.content = {
            ...styledSlide.content,
            color_theme: analysis.industryTheme as ColorTheme || 'blue',
            design_style: analysis.designStyle || 'modern',
            font_style: analysis.fontStyle || 'sans-serif'
          };
      ...
      setSelectedTheme(analysis.industryTheme as ColorTheme || 'blue');
